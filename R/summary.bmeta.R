...
#' @param show.neff A logical value indicating whether to show the effective sample size column (n.eff) and Rhat. Defaults to `FALSE`.
#' @param ... \dots
#'
#' @export
summary.bmeta = function(object, digits = 3, show.neff = FALSE, ...) {

  bugs.output = object$BUGSoutput
  bugs.summary = bugs.output$summary

  # Filter columns based on show.neff
  if (!show.neff) {
